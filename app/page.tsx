  ...
  return (
    <div className="">
      ...
      <div>
        ...
        <p>A Liberty CRED é uma empresa especializada em soluções financeiras inteligentes, atuando com ética, transparência e estratégia para ajudar pessoas a recuperarem crédito, reduzirem dívidas e tomarem decisões seguras.
          Nosso objetivo é oferecer caminhos reais, simples e eficientes — sem burocracia, sem promessas vazias e com total segurança.
        </p>
        <h3>Pontos fortes!</h3>
        <ul>
          <li> Consultoria personalizada
          </li>
          <li> Processo seguro e amparado por legislação
          </li>
          <li>Equipe especializada
          </li>
          <li>Transparência total
          </li>
          <li>Alta taxa de sucesso
          </li>
        </ul>
      </div>
      <div>
